      ...
      <div className="max-w-[1022px] mx-auto py-4 flex items-center justify-between">
        ...
        {signIn && (
          <Link href="/login" className="flex items-center gap-x-1">
            <button className="flex font-medium items-center h-[29px] px-3 gap-x-1 active:scale-95 transition-all text-light-str bg-gradient-to-t from-[#D5224E] to-[#FF003F] rounded">
